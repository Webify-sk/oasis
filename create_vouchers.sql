...
create table if not exists public.vouchers (
  ...
  purchaser_id uuid references auth.users(id) on delete set null, -- Nullable if generated by admin manually without purchase
  recipient_email text,
  sender_name text,
  message text,
  credit_amount int not null, -- Store copy here in case product changes
