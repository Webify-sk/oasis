...
function removeAccents(str: any): string {
    if (str == null) return "";
    let clean = String(str).normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    // Strip characters that pdf-lib's WinAnsi cannot encode to prevent crashes (like emojis or special unicode)
    clean = clean.replace(/[^\x00-\xFF\u0152\u0153\u0178\u0160\u0161\u017D\u017E\u0192\u20AC\u201A\u201E\u2026\u2020\u2021\u02C6\u2030\u2039\u2018\u2019\u201C\u201D\u2022\u2013\u2014\u02DC\u2122\u203A]/g, "");
    return clean;
}
