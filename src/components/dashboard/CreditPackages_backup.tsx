                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', marginBottom: '2rem' }}>
                            <label style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', fontSize: '0.9rem', cursor: 'pointer' }}>
                                ...
                                />
                                <span>
                                    Súhlasím so <a href="/vop" target="_blank" style={{ textDecoration: 'underline', color: '#8C7568' }}>Všeobecnými obchodnými podmienkami (VOP)</a>
                                </span>
                            </label>
                            ...
                            <label style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', fontSize: '0.9rem', cursor: 'pointer' }}>
                                ...
                                />
                                <span>
                                    Súhlasím so spracovaním osobných údajov <a href="/gdpr" target="_blank" style={{ textDecoration: 'underline', color: '#8C7568' }}>(GDPR)</a>
                                </span>
                            </label>
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'flex-end' }}>
                            ...
                            <Button
                                ...
                                disabled={!termsAccepted || !privacyAccepted || loadingId !== null}
